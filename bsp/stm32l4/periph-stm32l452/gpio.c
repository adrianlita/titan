...
#define AF_TIM15        (1 << 3)
#define AF_TIM16        (1 << 4)
#define AF_LPTIM1       (1 << 5)
#define AF_LPTIM2       (1 << 6)
#define AF_I2C1         (1 << 7)
#define AF_I2C2         (1 << 8)
#define AF_I2C3         (1 << 9)
#define AF_I2C4         (1 << 10)
...
#define AF_SPI2         (1 << 12)
#define AF_SPI3         (1 << 13)
#define AF_UART1        (1 << 14)
#define AF_UART2        (1 << 15)
#define AF_UART3        (1 << 16)
#define AF_UART4        (1 << 17)
#define AF_LPUART1      (1 << 18)
#define AF_USB          (1 << 19)
#define AF_QUADSPI      (1 << 20)
#define AF_CAN1         (1 << 21)
#define AF_SDMMC1       (1 << 22)
#define AF_SAI1         (1 << 23)
#define AF_TSC          (1 << 24)
#define AF_DFSDM        (1 << 25)
#define AF_COMP1        (1 << 26)
#define AF_COMP2        (1 << 27)
#define AF_SYSAF        (1 << 28)




static const titan_gpio_t titan_pin_defs[TITAN_GPIO_TOTAL_PINS] = {
    {.gpio = GPIOA, .pin = LL_GPIO_PIN_0,  .adc = 0x15, .dac = 0x00, .pwm = 0x00, .af0 = 0,              .af1 = AF_TIM2,        .af2 = 0,             .af3 = 0,             .af4 = 0,             .af5 = 0,             .af6 = 0,             .af7 = AF_UART2,      .af8 = AF_UART4,      .af9 = 0,             .af10 = 0,             .af12 = AF_COMP1,      .af13 = AF_SAI1,       .af14 = AF_TIM2        },
    {.gpio = GPIOA, .pin = LL_GPIO_PIN_1,  .adc = 0x16, .dac = 0x00, .pwm = 0x00, .af0 = 0,              .af1 = AF_TIM2,        .af2 = 0,             .af3 = 0,             .af4 = AF_I2C1,       .af5 = AF_SPI1,       .af6 = 0,             .af7 = AF_UART2,      .af8 = AF_UART4,      .af9 = 0,             .af10 = 0,             .af12 = 0,             .af13 = 0,             .af14 = AF_TIM15       },
    ...
    {.gpio = GPIOA, .pin = LL_GPIO_PIN_5,  .adc = 0x1A, .dac = 0x00, .pwm = 0x00, .af0 = 0,              .af1 = AF_TIM2,        .af2 = AF_TIM2,       .af3 = 0,             .af4 = 0,             .af5 = AF_SPI1,       .af6 = AF_DFSDM,      .af7 = 0,             .af8 = 0,             .af9 = 0,             .af10 = 0,             .af12 = 0,             .af13 = 0,             .af14 = AF_LPTIM2      },
    {.gpio = GPIOA, .pin = LL_GPIO_PIN_6,  .adc = 0x1B, .dac = 0x00, .pwm = 0x31, .af0 = 0,              .af1 = AF_TIM1,        .af2 = AF_TIM3,       .af3 = 0,             .af4 = 0,             .af5 = AF_SPI1,       .af6 = AF_COMP1,      .af7 = AF_UART3,      .af8 = AF_LPUART1,    .af9 = 0,             .af10 = AF_QUADSPI,    .af12 = AF_TIM1,       .af13 = 0,             .af14 = AF_TIM16       },
    {.gpio = GPIOA, .pin = LL_GPIO_PIN_7,  .adc = 0x1C, .dac = 0x00, .pwm = 0x32, .af0 = 0,              .af1 = AF_TIM1,        .af2 = AF_TIM3,       .af3 = 0,             .af4 = AF_I2C3,       .af5 = AF_SPI1,       .af6 = AF_DFSDM,      .af7 = 0,             .af8 = 0,             .af9 = 0,             .af10 = AF_QUADSPI,    .af12 = AF_COMP2,      .af13 = 0,             .af14 = 0              },
    {.gpio = GPIOA, .pin = LL_GPIO_PIN_8,  .adc = 0x00, .dac = 0x00, .pwm = 0x11, .af0 = AF_SYSAF,       .af1 = AF_TIM1,        .af2 = 0,             .af3 = 0,             .af4 = 0,             .af5 = 0,             .af6 = AF_DFSDM,      .af7 = AF_UART1,      .af8 = 0,             .af9 = 0,             .af10 = 0,             .af12 = 0,             .af13 = AF_SAI1,       .af14 = AF_LPTIM2      },
    {.gpio = GPIOA, .pin = LL_GPIO_PIN_9,  .adc = 0x00, .dac = 0x00, .pwm = 0x12, .af0 = 0,              .af1 = AF_TIM1,        .af2 = 0,             .af3 = 0,             .af4 = AF_I2C1,       .af5 = 0,             .af6 = AF_DFSDM,      .af7 = AF_UART1,      .af8 = 0,             .af9 = 0,             .af10 = 0,             .af12 = 0,             .af13 = AF_SAI1,       .af14 = AF_TIM15       },
    {.gpio = GPIOA, .pin = LL_GPIO_PIN_10, .adc = 0x00, .dac = 0x00, .pwm = 0x13, .af0 = 0,              .af1 = AF_TIM1,        .af2 = 0,             .af3 = 0,             .af4 = AF_I2C1,       .af5 = 0,             .af6 = 0,             .af7 = AF_UART1,      .af8 = 0,             .af9 = 0,             .af10 = AF_USB,        .af12 = 0,             .af13 = AF_SAI1,       .af14 = 0              },
    {.gpio = GPIOA, .pin = LL_GPIO_PIN_11, .adc = 0x00, .dac = 0x00, .pwm = 0x14, .af0 = 0,              .af1 = AF_TIM1,        .af2 = AF_TIM1,       .af3 = 0,             .af4 = 0,             .af5 = AF_SPI1,       .af6 = AF_COMP1,      .af7 = AF_UART1,      .af8 = 0,             .af9 = AF_CAN1,       .af10 = AF_USB,        .af12 = AF_TIM1,       .af13 = 0,             .af14 = 0              },
    {.gpio = GPIOA, .pin = LL_GPIO_PIN_12, .adc = 0x00, .dac = 0x00, .pwm = 0x00, .af0 = 0,              .af1 = AF_TIM1,        .af2 = 0,             .af3 = 0,             .af4 = 0,             .af5 = AF_SPI1,       .af6 = 0,             .af7 = AF_UART1,      .af8 = 0,             .af9 = AF_CAN1,       .af10 = AF_USB,        .af12 = 0,             .af13 = 0,             .af14 = 0              },
    {.gpio = GPIOA, .pin = LL_GPIO_PIN_13, .adc = 0x00, .dac = 0x00, .pwm = 0x00, .af0 = AF_SYSAF,       .af1 = 0      ,        .af2 = 0,             .af3 = 0,             .af4 = 0,             .af5 = 0,             .af6 = 0,             .af7 = 0,             .af8 = 0,             .af9 = 0,             .af10 = AF_USB,        .af12 = 0,             .af13 = AF_SAI1,       .af14 = 0              },
    {.gpio = GPIOA, .pin = LL_GPIO_PIN_14, .adc = 0x00, .dac = 0x00, .pwm = 0x00, .af0 = AF_SYSAF,       .af1 = AF_LPTIM1,      .af2 = 0,             .af3 = 0,             .af4 = AF_I2C1,       .af5 = AF_I2C4,       .af6 = 0,             .af7 = 0,             .af8 = 0,             .af9 = 0,             .af10 = 0,             .af12 = 0,             .af13 = AF_SAI1,       .af14 = 0              },
    {.gpio = GPIOA, .pin = LL_GPIO_PIN_15, .adc = 0x00, .dac = 0x00, .pwm = 0x00, .af0 = AF_SYSAF,       .af1 = AF_TIM2,        .af2 = AF_TIM2,       .af3 = AF_UART2,      .af4 = 0,             .af5 = AF_SPI1,       .af6 = AF_SPI3,       .af7 = AF_UART3,      .af8 = AF_UART4,      .af9 = AF_TSC,        .af10 = 0,             .af12 = 0,             .af13 = 0,             .af14 = 0              },

    {.gpio = GPIOB, .pin = LL_GPIO_PIN_0,  .adc = 0x1F, .dac = 0x00, .pwm = 0x33, .af0 = 0,              .af1 = AF_TIM1,        .af2 = AF_TIM3,       .af3 = 0,             .af4 = 0,             .af5 = AF_SPI1,       .af6 = AF_DFSDM,      .af7 = AF_UART3,      .af8 = 0,             .af9 = 0,             .af10 = AF_QUADSPI,    .af12 = AF_COMP1,      .af13 = AF_SAI1,       .af14 = 0              },
    {.gpio = GPIOB, .pin = LL_GPIO_PIN_1,  .adc = 0x10, .dac = 0x00, .pwm = 0x34, .af0 = 0,              .af1 = AF_TIM1,        .af2 = AF_TIM3,       .af3 = 0,             .af4 = 0,             .af5 = 0,             .af6 = AF_DFSDM,      .af7 = AF_UART3,      .af8 = AF_LPUART1,    .af9 = 0,             .af10 = AF_QUADSPI,    .af12 = 0,             .af13 = 0,             .af14 = AF_LPTIM2      },
    {.gpio = GPIOB, .pin = LL_GPIO_PIN_2,  .adc = 0x00, .dac = 0x00, .pwm = 0x00, .af0 = AF_SYSAF,       .af1 = AF_LPTIM1,      .af2 = 0,             .af3 = 0,             .af4 = AF_I2C3,       .af5 = 0,             .af6 = AF_DFSDM,      .af7 = 0,             .af8 = 0,             .af9 = 0,             .af10 = 0,             .af12 = 0,             .af13 = 0,             .af14 = 0              },
    ...
    {.gpio = GPIOB, .pin = LL_GPIO_PIN_4,  .adc = 0x00, .dac = 0x00, .pwm = 0x31, .af0 = AF_SYSAF,       .af1 = 0,              .af2 = AF_TIM3,       .af3 = 0,             .af4 = AF_I2C3,       .af5 = AF_SPI1,       .af6 = AF_SPI3,       .af7 = AF_UART1,      .af8 = 0,             .af9 = AF_TSC,        .af10 = 0,             .af12 = 0,             .af13 = AF_SAI1,       .af14 = 0              },
    {.gpio = GPIOB, .pin = LL_GPIO_PIN_5,  .adc = 0x00, .dac = 0x00, .pwm = 0x32, .af0 = 0,              .af1 = AF_LPTIM1,      .af2 = AF_TIM3,       .af3 = AF_CAN1,       .af4 = AF_I2C1,       .af5 = AF_SPI1,       .af6 = AF_SPI3,       .af7 = AF_UART1,      .af8 = 0,             .af9 = AF_TSC,        .af10 = 0,             .af12 = AF_COMP2,      .af13 = AF_SAI1,       .af14 = AF_TIM16       },
    {.gpio = GPIOB, .pin = LL_GPIO_PIN_6,  .adc = 0x00, .dac = 0x00, .pwm = 0x00, .af0 = 0,              .af1 = AF_LPTIM1,      .af2 = 0,             .af3 = 0,             .af4 = AF_I2C1,       .af5 = AF_I2C4,       .af6 = 0,             .af7 = AF_UART1,      .af8 = AF_CAN1,       .af9 = AF_TSC,        .af10 = 0,             .af12 = 0,             .af13 = AF_SAI1,       .af14 = AF_TIM16       },
    {.gpio = GPIOB, .pin = LL_GPIO_PIN_7,  .adc = 0x00, .dac = 0x00, .pwm = 0x00, .af0 = 0,              .af1 = AF_LPTIM1,      .af2 = 0,             .af3 = 0,             .af4 = AF_I2C1,       .af5 = AF_I2C4,       .af6 = 0,             .af7 = AF_UART1,      .af8 = AF_UART4,      .af9 = AF_TSC,        .af10 = 0,             .af12 = 0,             .af13 = 0,             .af14 = 0              },
    {.gpio = GPIOB, .pin = LL_GPIO_PIN_8,  .adc = 0x00, .dac = 0x00, .pwm = 0x00, .af0 = 0,              .af1 = 0,              .af2 = 0,             .af3 = 0,             .af4 = AF_I2C1,       .af5 = 0,             .af6 = 0,             .af7 = 0,             .af8 = 0,             .af9 = AF_CAN1,       .af10 = 0,             .af12 = AF_SDMMC1,     .af13 = AF_SAI1,       .af14 = AF_TIM16       },
    {.gpio = GPIOB, .pin = LL_GPIO_PIN_9,  .adc = 0x00, .dac = 0x00, .pwm = 0x00, .af0 = 0,              .af1 = 0,              .af2 = 0,             .af3 = 0,             .af4 = AF_I2C1,       .af5 = AF_SPI2,       .af6 = 0,             .af7 = 0,             .af8 = 0,             .af9 = AF_CAN1,       .af10 = 0,             .af12 = AF_SDMMC1,     .af13 = AF_SAI1,       .af14 = 0              },
    {.gpio = GPIOB, .pin = LL_GPIO_PIN_10, .adc = 0x00, .dac = 0x00, .pwm = 0x00, .af0 = 0,              .af1 = AF_TIM2,        .af2 = 0,             .af3 = AF_I2C4,       .af4 = AF_I2C2,       .af5 = AF_SPI2,       .af6 = 0,             .af7 = AF_UART3,      .af8 = AF_LPUART1,    .af9 = AF_TSC,        .af10 = AF_QUADSPI,    .af12 = AF_COMP1,      .af13 = AF_SAI1,       .af14 = 0              },
    {.gpio = GPIOB, .pin = LL_GPIO_PIN_11, .adc = 0x00, .dac = 0x00, .pwm = 0x00, .af0 = 0,              .af1 = AF_TIM2,        .af2 = 0,             .af3 = AF_I2C4,       .af4 = AF_I2C2,       .af5 = 0,             .af6 = 0,             .af7 = AF_UART3,      .af8 = AF_LPUART1,    .af9 = 0,             .af10 = AF_QUADSPI,    .af12 = AF_COMP2,      .af13 = 0,             .af14 = 0              },
    {.gpio = GPIOB, .pin = LL_GPIO_PIN_12, .adc = 0x00, .dac = 0x00, .pwm = 0x00, .af0 = 0,              .af1 = AF_TIM1,        .af2 = 0,             .af3 = AF_TIM1,       .af4 = AF_I2C2,       .af5 = AF_SPI2,       .af6 = AF_DFSDM,      .af7 = AF_UART3,      .af8 = AF_LPUART1,    .af9 = AF_TSC,        .af10 = AF_CAN1,       .af12 = 0,             .af13 = AF_SAI1,       .af14 = AF_TIM15       },
    {.gpio = GPIOB, .pin = LL_GPIO_PIN_13, .adc = 0x00, .dac = 0x00, .pwm = 0x00, .af0 = 0,              .af1 = AF_TIM1,        .af2 = 0,             .af3 = 0,             .af4 = AF_I2C2,       .af5 = AF_SPI2,       .af6 = AF_DFSDM,      .af7 = AF_UART3,      .af8 = AF_LPUART1,    .af9 = AF_TSC,        .af10 = AF_CAN1,       .af12 = 0,             .af13 = AF_SAI1,       .af14 = AF_TIM15       },
    {.gpio = GPIOB, .pin = LL_GPIO_PIN_14, .adc = 0x00, .dac = 0x00, .pwm = 0x00, .af0 = 0,              .af1 = AF_TIM1,        .af2 = 0,             .af3 = 0,             .af4 = AF_I2C2,       .af5 = AF_SPI2,       .af6 = AF_DFSDM,      .af7 = AF_UART3,      .af8 = 0,             .af9 = AF_TSC,        .af10 = 0,             .af12 = 0,             .af13 = AF_SAI1,       .af14 = AF_TIM15       },
    {.gpio = GPIOB, .pin = LL_GPIO_PIN_15, .adc = 0x00, .dac = 0x00, .pwm = 0x00, .af0 = AF_SYSAF,       .af1 = AF_TIM1,        .af2 = 0,             .af3 = 0,             .af4 = 0,             .af5 = AF_SPI2,       .af6 = AF_DFSDM,      .af7 = 0,             .af8 = 0,             .af9 = AF_TSC,        .af10 = 0,             .af12 = 0,             .af13 = AF_SAI1,       .af14 = AF_TIM15       },

    {.gpio = GPIOC, .pin = LL_GPIO_PIN_0,  .adc = 0x11, .dac = 0x00, .pwm = 0x00, .af0 = 0,              .af1 = AF_LPTIM1,      .af2 = AF_I2C4,       .af3 = 0,             .af4 = AF_I2C3,       .af5 = 0,             .af6 = 0,             .af7 = 0,             .af8 = AF_LPUART1,    .af9 = 0,             .af10 = 0,             .af12 = 0,             .af13 = 0,             .af14 = AF_LPTIM2      },
    {.gpio = GPIOC, .pin = LL_GPIO_PIN_1,  .adc = 0x12, .dac = 0x00, .pwm = 0x00, .af0 = AF_SYSAF,       .af1 = AF_LPTIM1,      .af2 = AF_I2C4,       .af3 = 0,             .af4 = AF_I2C3,       .af5 = 0,             .af6 = 0,             .af7 = 0,             .af8 = AF_LPUART1,    .af9 = 0,             .af10 = 0,             .af12 = 0,             .af13 = 0,             .af14 = 0              },
    {.gpio = GPIOC, .pin = LL_GPIO_PIN_2,  .adc = 0x13, .dac = 0x00, .pwm = 0x00, .af0 = 0,              .af1 = AF_LPTIM1,      .af2 = 0,             .af3 = 0,             .af4 = 0,             .af5 = AF_SPI2,       .af6 = AF_DFSDM,      .af7 = 0,             .af8 = 0,             .af9 = 0,             .af10 = 0,             .af12 = 0,             .af13 = 0,             .af14 = 0              },
    {.gpio = GPIOC, .pin = LL_GPIO_PIN_3,  .adc = 0x14, .dac = 0x00, .pwm = 0x00, .af0 = 0,              .af1 = AF_LPTIM1,      .af2 = 0,             .af3 = 0,             .af4 = 0,             .af5 = AF_SPI2,       .af6 = 0,             .af7 = 0,             .af8 = 0,             .af9 = 0,             .af10 = 0,             .af12 = 0,             .af13 = AF_SAI1,       .af14 = AF_LPTIM2      },
    {.gpio = GPIOC, .pin = LL_GPIO_PIN_4,  .adc = 0x1D, .dac = 0x00, .pwm = 0x00, .af0 = 0,              .af1 = 0,              .af2 = 0,             .af3 = 0,             .af4 = 0,             .af5 = 0,             .af6 = 0,             .af7 = AF_UART3,      .af8 = 0,             .af9 = 0,             .af10 = 0,             .af12 = 0,             .af13 = 0,             .af14 = 0              },
    {.gpio = GPIOC, .pin = LL_GPIO_PIN_5,  .adc = 0x1E, .dac = 0x00, .pwm = 0x00, .af0 = 0,              .af1 = 0,              .af2 = 0,             .af3 = 0,             .af4 = 0,             .af5 = 0,             .af6 = 0,             .af7 = AF_UART3,      .af8 = 0,             .af9 = 0,             .af10 = 0,             .af12 = 0,             .af13 = 0,             .af14 = 0              },
    {.gpio = GPIOC, .pin = LL_GPIO_PIN_6,  .adc = 0x00, .dac = 0x00, .pwm = 0x31, .af0 = 0,              .af1 = 0,              .af2 = AF_TIM3,       .af3 = 0,             .af4 = 0,             .af5 = 0,             .af6 = AF_DFSDM,      .af7 = 0,             .af8 = 0,             .af9 = AF_TSC,        .af10 = 0,             .af12 = AF_SDMMC1,     .af13 = 0,             .af14 = 0              },
    {.gpio = GPIOC, .pin = LL_GPIO_PIN_7,  .adc = 0x00, .dac = 0x00, .pwm = 0x32, .af0 = 0,              .af1 = 0,              .af2 = AF_TIM3,       .af3 = 0,             .af4 = 0,             .af5 = 0,             .af6 = AF_DFSDM,      .af7 = 0,             .af8 = 0,             .af9 = AF_TSC,        .af10 = 0,             .af12 = AF_SDMMC1,     .af13 = 0,             .af14 = 0              },
    {.gpio = GPIOC, .pin = LL_GPIO_PIN_8,  .adc = 0x00, .dac = 0x00, .pwm = 0x33, .af0 = 0,              .af1 = 0,              .af2 = AF_TIM3,       .af3 = 0,             .af4 = 0,             .af5 = 0,             .af6 = 0,             .af7 = 0,             .af8 = 0,             .af9 = AF_TSC,        .af10 = 0,             .af12 = AF_SDMMC1,     .af13 = 0,             .af14 = 0              },
    {.gpio = GPIOC, .pin = LL_GPIO_PIN_9,  .adc = 0x00, .dac = 0x00, .pwm = 0x34, .af0 = 0,              .af1 = 0,              .af2 = AF_TIM3,       .af3 = 0,             .af4 = 0,             .af5 = 0,             .af6 = 0,             .af7 = 0,             .af8 = 0,             .af9 = AF_TSC,        .af10 = AF_USB,        .af12 = AF_SDMMC1,     .af13 = 0,             .af14 = 0              },
    {.gpio = GPIOC, .pin = LL_GPIO_PIN_10, .adc = 0x00, .dac = 0x00, .pwm = 0x00, .af0 = AF_SYSAF,       .af1 = 0,              .af2 = 0,             .af3 = 0,             .af4 = 0,             .af5 = 0,             .af6 = AF_SPI2,       .af7 = AF_UART3,      .af8 = AF_UART4,      .af9 = AF_TSC,        .af10 = 0,             .af12 = AF_SDMMC1,     .af13 = 0,             .af14 = 0              },
    {.gpio = GPIOC, .pin = LL_GPIO_PIN_11, .adc = 0x00, .dac = 0x00, .pwm = 0x00, .af0 = 0,              .af1 = 0,              .af2 = 0,             .af3 = 0,             .af4 = 0,             .af5 = 0,             .af6 = AF_SPI2,       .af7 = AF_UART3,      .af8 = AF_UART4,      .af9 = AF_TSC,        .af10 = 0,             .af12 = AF_SDMMC1,     .af13 = 0,             .af14 = 0              },
    {.gpio = GPIOC, .pin = LL_GPIO_PIN_12, .adc = 0x00, .dac = 0x00, .pwm = 0x00, .af0 = AF_SYSAF,       .af1 = 0,              .af2 = 0,             .af3 = 0,             .af4 = 0,             .af5 = 0,             .af6 = AF_SPI2,       .af7 = AF_UART3,      .af8 = 0,             .af9 = AF_TSC,        .af10 = 0,             .af12 = AF_SDMMC1,     .af13 = 0,             .af14 = 0              },
    {.gpio = GPIOC, .pin = LL_GPIO_PIN_13, .adc = 0x00, .dac = 0x00, .pwm = 0x00, .af0 = 0,              .af1 = 0,              .af2 = 0,             .af3 = 0,             .af4 = 0,             .af5 = 0,             .af6 = 0,             .af7 = 0,             .af8 = 0,             .af9 = 0,             .af10 = 0,             .af12 = 0,             .af13 = 0,             .af14 = 0              },
    ...
    {.gpio = GPIOC, .pin = LL_GPIO_PIN_15, .adc = 0x00, .dac = 0x00, .pwm = 0x00, .af0 = 0,              .af1 = 0,              .af2 = 0,             .af3 = 0,             .af4 = 0,             .af5 = 0,             .af6 = 0,             .af7 = 0,             .af8 = 0,             .af9 = 0,             .af10 = 0,             .af12 = 0,             .af13 = 0,             .af14 = 0              },

    {.gpio = GPIOD, .pin = LL_GPIO_PIN_2 , .adc = 0x00, .dac = 0x00, .pwm = 0x00, .af0 = AF_SYSAF,       .af1 = 0,              .af2 = AF_TIM3,       .af3 = 0,             .af4 = 0,             .af5 = 0,             .af6 = 0,             .af7 = AF_UART3,      .af8 = 0,             .af9 = AF_TSC,        .af10 = 0,             .af12 = AF_SDMMC1,     .af13 = 0,             .af14 = 0              },
};
    ...
    switch(function) {
        case GPIO_SPECIAL_FUNCTION_I2C:
            ...
            switch(param) {
                ...
                case (uint32_t)I2C4:
                    if(titan_pin_defs[pin].af2 == AF_I2C4) {
                        _gpio_set_af(titan_pin_defs[pin].gpio, titan_pin_defs[pin].pin, LL_GPIO_AF_2);
                    }
                    else if(titan_pin_defs[pin].af3 == AF_I2C4) {
                        _gpio_set_af(titan_pin_defs[pin].gpio, titan_pin_defs[pin].pin, LL_GPIO_AF_3);
                    }
                    else if(titan_pin_defs[pin].af4 == AF_I2C4) {
                        _gpio_set_af(titan_pin_defs[pin].gpio, titan_pin_defs[pin].pin, LL_GPIO_AF_4);
                    }
                    else if(titan_pin_defs[pin].af5 == AF_I2C4) {
        ...
        case GPIO_SPECIAL_FUNCTION_SDMMC:

            if(titan_pin_defs[pin].af12 == AF_SDMMC1) {
                _gpio_set_af(titan_pin_defs[pin].gpio, titan_pin_defs[pin].pin, LL_GPIO_AF_12);
            }
            else {
                passert(0);
            }
        ...
        case GPIO_SPECIAL_FUNCTION_TIMER:
            switch(param) {
                ...
                case (uint32_t)TIM3:
                    if(titan_pin_defs[pin].af2 == AF_TIM3) {
                        _gpio_set_af(titan_pin_defs[pin].gpio, titan_pin_defs[pin].pin, LL_GPIO_AF_2);
                    }
                    else {
                        passert(0);
        ...
        case GPIO_SPECIAL_FUNCTION_UART:
            ...
            switch(param) {
                ...
                case (uint32_t)UART4:
                    if(titan_pin_defs[pin].af8 == AF_UART4) {
        ...
        case GPIO_SPECIAL_FUNCTION_USB:
            if(titan_pin_defs[pin].af10 == AF_USB) {
                _gpio_set_af(titan_pin_defs[pin].gpio, titan_pin_defs[pin].pin, LL_GPIO_AF_10);
            }
            else {
                passert(0);
            }
